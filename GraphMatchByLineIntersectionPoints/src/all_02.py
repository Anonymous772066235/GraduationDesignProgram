...
# 搜索直线
Lines_dlg = lf.searchLines(data_dlg, 16,1000, 6, 0.5)
Lines_dopp = lf.searchLines(data_dopp, 16,1000, 6, 0.5)
...
# 计算变换矩阵(并对dopp进行变换)
R, T = tf.ca_rt(P_dopp_new, P_dlg, 'MatchingByLineIntersectionPoints_result_ransac.txt')
