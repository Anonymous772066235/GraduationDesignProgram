...
A.Ca_DoPP(15)
A.Show_GRID()
A.ca_DATA3('PCB_c0.5_z1_t15.txt')
...
plt.xticks([])
plt.yticks([])
plt.savefig('dopp_result__c0.5_z1_t15.png')

Plane=plane(A.DATA3,2,4)
np.savetxt('dopp_PLANE__c0.5_z2-4_t15.txt',Plane,delimiter=" ", )
plt.figure(figsize=(16,9))
plt.axis('equal')
plt.scatter(Plane[:,0],Plane[:,1],c='black',s=1)
# plt.axis('off')
# plt.xticks([])
# plt.yticks([])
plt.savefig('dopp_PLANE__c0.5_z2-4_t15.png')
